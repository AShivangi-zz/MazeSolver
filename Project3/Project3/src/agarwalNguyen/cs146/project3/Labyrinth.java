...
public class Labyrinth
{
    ...
    private void generate(){
        ...
        while (visited < total) {
            ...
            //System.out.println(visited + " Current X: " + current.x + " Y: " + current.y + "     Nulls: " + nullCounter);
            ...
            if (nullCounter != 4) {
                ...
                while (!chosen) {
                    ...
                    if (local[choice] != null) {
                        ...
                        rand = local[choice];
                        chosen = true;
                        //System.out.println("  Random Position: " + choice + " -> " + local[choice].x + " " + local[choice].y);
                    }
                }
                ...
                if (pos == 0) {
                    ...
                    c.add(rand.x);
                    d.add(rand.y);
                    //System.out.println("  KNOCKING DWN BETWEEN: " + current.x + " " + current.y + " AND " + +rand.x + " " + rand.y + "\n");
                }
                if (pos == 1) {
